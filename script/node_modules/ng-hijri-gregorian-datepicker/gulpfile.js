...
gulp.task('js', function(){
    return es.merge(getTemplatesStream(), gulp.src(paths.src.js))
        ...
        .pipe($.ngAnnotate())
        .pipe($.concat('ng-hijri-gregorian-datepicker.js'))
        .pipe(gulp.dest(paths.dist))
        .pipe($.uglify())
        .pipe($.rename('ng-hijri-gregorian-datepicker.min.js'))
        .pipe(gulp.dest(paths.dist));
});
...
gulp.task('sass', function(){
    return gulp.src(paths.src.scss)
        ...
        .pipe($.rename('ng-hijri-gregorian-datepicker.css'))
        .pipe(gulp.dest(paths.dist))
        .pipe($.csso())
        .pipe($.rename('ng-hijri-gregorian-datepicker.min.css'))
        .pipe(gulp.dest(paths.dist));
});
