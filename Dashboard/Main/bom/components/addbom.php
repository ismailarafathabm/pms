...
<div class="sub-body" style="margin-top: 98px;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="display:flex">
                                                <input type="text" class="old_page_inputs"  name="itemid" tabindex="0" style="display:none" />
                                                <input type="text" class="old_page_inputs" id="show_itemid" name="profileno" tabindex="0" />
                                                
                                                <button type="button" style="font-size:8px" ng-click="search_box()">
...
<?php 
    include_once './reserve.dia.php';
    include_once './reserveproject.dia.php';
    include_once './reserveitems.dia.php';
?>