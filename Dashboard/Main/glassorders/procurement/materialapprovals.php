    ...
    <div class="sub-body-container" style="margin-top: 100px;padding:0;overflow:hidden; font-family: 'roboto',sans-serif;font-size : 1rem;height:calc(100vh - 140px)">
        ...
        <div class="ism-new-page-headers">
            ...
            <div class="ism-new-page-header-page-buttons">
                ...
                <button type="button" class="ism-new-page-header-button normalbtn" ng-click="addnewmaterialorder()">
                    <i class="fa fa-plus" style="margin-right:1px"></i>
                    Add
                </button>
            </div>
        </div>
        <div style="height: calc(100vh - 230px);overflow: auto;border: 1px solid #d9d9d9;">
        ...
        <div class='totalinfo'>
            <div class="budget_total" style="color: #a00;">Cost Total (SAR.): <span style="font-weight: 600;">{{sum.cost}}</span> </div>            
        </div>
    </div>
</div>
<?php
include_once 'models/materialorder.php';
