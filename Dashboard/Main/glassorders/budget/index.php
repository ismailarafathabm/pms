    ...
    <div class="sub-body-container"
        ...
        <div class="ism-new-page-headers">
            ...
            <div class="ism-new-page-header-page-buttons">
                ...
                <button ng-if="access.newbutton" type="button" class="ism-new-page-header-button successbtn" ng-click="addnewgobudget()" style="margin-left:20px">
                    <i class="fa fa-plus" style="margin-right:1px"></i>
                    Add
                </button>
                <button ng-if="access.newbutton" type="button" class="ism-new-page-header-button dangerbtn" ng-click="addnewgobudgets()" style="margin-left:5px">
                    <i class="fa fa-plus" style="margin-right:1px"></i>
                    Additionals
                </button>
            </div>
        ...
        <div class='totalinfo'>
            ...
            <div class="budget_total" style="color: #008537;">Area Total (m<sup>2</sup>) : <span
                    style="font-weight: 600;">{{sum.area}}</span> </div>
        </div>
    </div>
</div>
<?php
