    ...
    <div class="sub-body-container">
        <div class="sub-body-container-title">
            ...
            <div class="sub-container-right">
                ...
                <button ng-show="!isrptloading" ng-click="printrpt()" class="ism-btns btn-normal">
                ...
                <button ng-show="updatebutton && !isrptloading" ng-click="gropudelver_handler()" class="ism-btns btn-save">
                    <i class="fa fa-edit"></i>
                    Deliver
                </button>
                <?php } ?>
...
<?php 
include_once 'dia-history.php';
include_once 'dia-del-update.php';
?>