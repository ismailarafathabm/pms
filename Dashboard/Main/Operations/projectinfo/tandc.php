    ...
    <div class="route-container-content">
        <table class="project-list-table borderd">
            <tr ng-repeat="cn in _terms">
                ...
                <td style="width:50px"><button id="remove_conditions" ng-click="remove_terms(cn.payment_terms_id)" type="button" class="nafco-button nafco-sm-btn nafco-btn-danger nafco-btn-noborder"><i class="fa fa-trash"></i> Remove</button></td>
            </tr>
            ...
            <form name="add_new_terms" ng-submit="new_terms_add()">
                <div style="width:100%;min-height: 120px;padding:10px;background-color:#ffffea;border:1px solid #35b0ab">
                    <div style="width:100%;margin-top:15px; padding:4px;">
                        <textarea ng-model="terms_add_new" name="terms_add_new" id="terms_add_new" class="nafco_inputs" style="width:90%;" required></textarea>
                    </div>
                    <div style="width:100%;margin-top:15px; padding:0px;">
                        <button ng-disabled="add_new_terms.$invalid" type="submit" class="nafco_buttons simple btn-green" style="width:20%;margin-left:70%;padding:3px;border:1px solid #29c7ad">
