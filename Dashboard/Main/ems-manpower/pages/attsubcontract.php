...
<style>
    ...
    .grid-button {
        background-color: #1a87e600;
        color: #1a87e6;
        border: 1px solid #1a87e6;
        padding: 3px;
        border-radius: 3px;
        cursor: pointer;
        transition: all .9sec;
...
<div class="sub-body" style="margin-top: 75px;height: calc(100vh - 110px);">
    <div class="sub-body-container">
        <div class="sub-body-container-title" style="justify-content: space-between;">
            <div class="sub-container-left">
                ...
                Project With Date Wise Summary - Sub Contract Workers
            </div>
            <div ng-show="!isLoading" class="sub-container-right" style="display: flex;gap: 10px;align-items: center;justify-content: flex-start;">
                <button type="button" onclick="document.getElementById('rpt_src_dialog2').style.display='flex'" class="ism-btns btn-normal" style="margin-left:5px;">
        ...
        <div class="sub-body-container-contents" style="height:94%;background: #fff;">
            <div ng-show="isLoading">Fetching data please Wait......</div>
            <div ng-show="!isLoading" id="myGrid" class="ag-theme-balham" style="height:100%;"></div>
        </div>
    </div>
</div>
<?php
include_once 'date2.dia.php';
?>