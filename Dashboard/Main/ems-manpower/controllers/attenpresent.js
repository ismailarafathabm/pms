...
export default function manpowerAttenPresent($scope,$compile) {
    ...
    async function LoadReport() {
        ...
        const res = await apis.GET(`pms-manpower/monthlyattenpresent.php?stdate=${_startdate.value}&enddate=${_enddate.value}`);
        if (!res.isSuccess) {
            alert(res.msg);
            $scope.isLoading = false;
            $scope.$apply();
