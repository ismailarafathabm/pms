                    ...
                    <div class="old_pgm_row" style="flex-direction:column;gap:20px">
                        <div class="old_pgm_fitbox">
                            ...
                            <div ng-show="!ispageloading">
                                <table class="old_table itemlist" style="margin-bottom: 5px;">
                                    <tr>
                                        <td colspan="2">
                                            <div style="display: flex;justify-content:space-between">
                                                <div style="font-weight: bold;width:200px">Revised / Additional BOQ</div>
                                                <div style="display:flex;gap:2px">
                                                    <input type="radio" value="revised" ng-model="boqeng.boq_type">Revised BOQ |
                                                    <input type="radio" value="Additional" ng-model="boqeng.boq_type">Additional BOQ
                                                </div>

                                            </div>
                                        </td>
                                    </tr>
                                    <tr ng-show="boqeng.boq_type === 'revised'">
                                        <td colspan="2">
                                            <div style="display: flex;justify-content:space-between">
                                                <div style="font-weight: bold;">Supersede Status</div>
                                                <div style="display:flex;gap:2px">
                                                    <input type="radio" value="1" ng-model="boqeng.issupersede">Yes |
                                                    <input type="radio" value="0" ng-model="boqeng.issupersede">No
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr ng-show="boqeng.boq_type === 'revised' && boqeng.issupersede === '1'">
                                        <td style="width:200px">
                                            Old BOQ
                                        </td>
                                        <td>
                                            <select class="old_page_inputs" ng-model="boqeng.oldboqid" name="oldboqid" id="oldboqid" ng-change="oldgetboqinfo()">
                                    ...
                                    <tr>
                                        <td>Ref NO# / Revison</td>
                                        <td>
                                            <div style="display:flex;gap:5px">
                                                <input type="text" class="old_page_inputs" ng-model="boqeng.boq_refno" name="boq_refno" id="boq_refno"/> - 
                                                <input type="text" class="old_page_inputs" ng-model="boqeng.boq_reviewno" name="boq_reviewno" id="boq_reviewno" style="width: 120px;"/>
                                            </div>
                                        </td>
                                    </tr>
