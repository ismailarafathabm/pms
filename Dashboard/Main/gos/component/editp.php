                    ...
                    <div class="old_pgm_row" style="flex-direction:column;gap:20px">
                            ...
                            <table class="old_table itemlist" style="margin-bottom: 10px;width:693px">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="old_page_inputs" type="text" name="goproject" id="goproject" ng-model="newgo.goproject" required readonly/>
                                        </td>
                                        <td style="width:160px;text-align: right;">
                                            Location
                                        </td>
                                        <td>
                                            <input class="old_page_inputs" type="text" name="goprojectlocation" id="goprojectlocation" ng-model="newgo.goprojectlocation" required readonly/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:160px;text-align: right;">
                                        ...
                                        <td colspan="3">
                                            <input class="old_page_inputs" type="text" name="goprojectname" id="goprojectname" ng-model="newgo.goprojectname" required readonly/>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="old_table itemlist">
                                <tbody>
                                        ...
                                        <td colspan="4" style="font-weight:bold">
                                            <div class="groupccelss">
                                                ...
                                                <div>
                                                    ...
                                                    <label>R.GO</label>
                                                    <input type="radio" value="3" ng-model="newgo.gootype">
                                                    <label>B.GO</label>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <input list="gtype" class="old_page_inputs" type="text" name="goglasstype" id="goglasstype" ng-model="newgo.goglasstype" required />
                                            <datalist id="gtype">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <input list="gspec" class="old_page_inputs" type="text" name="goglassspec" id="goglassspec" ng-model="newgo.goglassspec" required />
                                            <datalist id="gspec">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <input list="markings" class="old_page_inputs" type="text" name="godate" id="godate" ng-model="newgo.godate" required ng-hijri-gregorian-datepicker="" datepicker-config="gregorianDatepickerConfigdotravels" selected-date="val_budgetdate3" />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <input list="gremark" class="old_page_inputs" type="text" name="remarks" id="remarks" ng-model="newgo.remarks" />
                                            <datalist id="gremark">
                        ...
                        <div class="old_pgm_fitbox">
                            <table class="old_table itemlist">
                                <tr>
                                    <td colspan="4">
                                        <button class="ism-btns btn-normal" type="button" ng-click="UpdateGO()" style="margin-left: 604px;display:flex;gap:2px;align-items: center;">
