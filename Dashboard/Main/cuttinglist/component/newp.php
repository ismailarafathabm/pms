    ...
    <div class="sub-body-container">
        <div class="sub-body-container-title">
            <div class="sub-container-left">
                ...
                New Cutting List - {{viewproject.project_name | uppercase}}
            </div>
                ...
                <div class="old_pgm">
                    <div class="old_pgm_row" style="flex-direction:column;gap:20px">
                        <div class="old_pgm_fitbox">
                                    ...
                                    <tr>
                                        <td colspan="4" style="font-weight:bold">
                                            <div class="groupccelss">
                                                ...
                                                <div>
                                                    <input ng-disabled="pagetype !== 'N' || isnproject" type="radio" value="1" ng-model="newct.cttype" ng-change="setctype('c')">
                                                    <label>Cutting List</label>
                                                    <input ng-disabled="pagetype !== 'N' || isnproject" type="radio" value="2" ng-model="newct.cttype" ng-change="setctype('s')">
                                                    <label>Sample</label>
                                                    <input ng-disabled="pagetype !== 'N' || isnproject" type="radio" value="3" ng-model="newct.cttype" ng-change="setctype('s')">
                            ...
                            <table class="old_table itemlist">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input g-change="calc_area()" class="old_page_inputs" type="text" name="ct_qty" id="ct_qty" ng-model="newct.ct_qty" ng-blur="checknovalue('ct_qty')" required />
                                        </td>
                            ...
                            <table class="old_table itemlist raidotables" style="margin-top: 5px;width:737px">
                                <tbody>
                                    <tr>
                                        <td colspan="4" style="font-weight:bold">
                                            <div class="groupccelss">
