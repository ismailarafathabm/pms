        ...
        <form autocomplete="off" ng-submit="updatestatusSubmit()" name="statusupdate" id="updatestatus" ng-show="!updatestatus.isloading">
            <div class="ism-pms-dialog-body">
                <div class="ism-pms-dialog-body-rows" style="width: 435px;">
                    ...
                    <div ng-show="updatestatus.type==='matterial_flag' && (+updatestatus.data.flagstatus) === 3" class="ism-pms-dialog-body-row-input-container half-widht" style="flex:1 0 200px">
                        <div class="ism-dialog-body-rows-input-container-lable">Material Status</div>
                        <div class="ism-dialog-body-rows-input-container-input ">                            
                            <select name="materialstatus" id="materialstatus" ng-model="updatestatus.data.materialstatus" class="ism-dialog-rows-input-controller" ng-required="updatestatus.type==='matterial_flag' && (+updatestatus.data.flagstatus) === 3" >
                                <option value="">-</option>
                                <?php
                    ...
                    <div ng-show="updatestatus.type==='matterial_flag' && (+updatestatus.data.flagstatus) === 3" class="ism-pms-dialog-body-row-input-container half-widht" style="flex:1 0 200px">
                        ...
                        <div class="ism-dialog-body-rows-input-container-input ">
                            <input name="materialrefno" id="materialrefno" ng-model="updatestatus.data.materialrefno" class="ism-dialog-rows-input-controller" ng-required="updatestatus.type==='matterial_flag' && (+updatestatus.data.flagstatus) === 3" />
                        </div>
                    </div>
