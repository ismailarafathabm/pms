        ...
        <div ng-show="!isloading" class="sub-body-container-contents">
            <div class="naf-table-div">
                <div class="naf-pms-table">
                    ...
                    <div class="naf-pms-row  naf-pms-header" style='background-color:#efeeee;top:26px'>
                        <div class="naf-pms-cell  naf-pms-header-cell"></div>
                        <div class="naf-pms-cell  naf-pms-header-cell"></div>
                        <div class="naf-pms-cell  naf-pms-header-cell"></div>
                    ...
                    <div class="naf-pms-row {{v.variation_status === '3' ? 'bg-red' : ''}}" ng-repeat="v in (xfilter = variationslist | filter : src)">
                        ...
                        <div class="naf-pms-cell" style="font-weight:bold">
                            <span class="fa fa-circle {{v.variation_status === '3' ? 'bg-red-fa' : ''}} "></span>
