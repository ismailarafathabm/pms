app.controller('rcfac',rcfac);

function rcfac($scope,$http){
    document.title = "POWDER COTTINGS REPORT [RECEIPT FACTORY] - PMS";    
    ...
    $scope.printResult = () => { 
        ...
        localStorage.setItem("printppreportstitle","PAINT PLANT RECEIPT - FACTORY");
