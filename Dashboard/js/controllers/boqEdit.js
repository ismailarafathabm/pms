app.controller('viewboq', function($scope, $http, $routeParams) {
    ...
    function get_boqinfo() {
        let post_data = {
            naf_user: userinfo,
            project_no: project_id,
            item_no: $routeParams.itemno
        };
