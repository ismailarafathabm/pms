...
<body>
    ...
    <h3>Drawing Approvals Report - Reports</h3>
...
<script>
    if (localStorage.getItem('print_drawingapprovals')) {
        var infos = localStorage.getItem('print_drawingapprovals');
        document.getElementById('print_data').innerHTML = infos;
        //localStorage.removeItem('print_drawingapprovals');
    }
</script>
