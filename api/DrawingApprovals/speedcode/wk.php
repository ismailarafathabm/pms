<?php 
    include_once('../../_def.php');    
        ...
        $sql = "SELECT *FROM (pms_draw_approvals inner join pms_draw_approvals_types on pms_draw_approvals_types.types_id = pms_draw_approvals.approvals_for) inner join pms_project_summary on pms_project_summary.project_no = pms_draw_approvals.approvals_project_code";
        $cm = $cn->prepare($sql);
        $cm->execute();
        $_approvals = [];
