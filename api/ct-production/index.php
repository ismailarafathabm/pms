<?php
     ...
     $sql = "SELECT *FROM pms_cuttinglist as  ct left join pms_cuttinglist_productions ctp on ct.ct_id = ctp.ctid where ct.production_flag = 3 and ct.production_returnflag <> 4 limit $limit,500";
     $cm = $cn->prepare($sql);
     $cm->execute();
     $rpts = [];
