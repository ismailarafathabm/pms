        ...
        if (!isset($data->new_boq->item_no) || $data->new_boq->item_no === "") {
            ...
            if ($data->new_boq->item_aras == '0' && $data->new_boq->item_qty == '0') {
                ...
                $_svdata = array(
                    ...
                    "poq_item_remark" => $data->new_boq->item_description,
                    ...
                    "poq_remark" => $data->new_boq->item_remark,
                    "poq_cby" => $_cby,
                    "poq_eby" => $_cby,
                    "poq_Cdate" => $_date,
                    "poq_Edate" => $_date,
                ...
                foreach ($data->notesitems as $notes) {
                    $specifiction_info = array(
                        'boq_note_project' => $data->poq_project_code,
                        'boq_note_itemno' => $data->new_boq->item_no,
                        'boq_note_notes' => $notes
                    );
                    $project->new_boq_notes($specifiction_info);   
                }

                echo $project->new_boq($_svdata);
            }
        }
    } else {
